package com.g2s.alpha.response.common//package com.g2s.alpha.response
//
//import com.g2s.alpha.common.ApiError
...
//    }
//
//    fun created(location: String? = null) = ApiResponse(HttpStatus.CREATED, location = location)
//    // In cases of resource creation, it indicates the URL to the newly created resource. [https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Location]
//
